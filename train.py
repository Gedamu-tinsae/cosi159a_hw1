...
def get_args():
    ...
    parser.add_argument('--test_only', action='store_true', help='Only run test set evaluation using the best or checkpoint model')
...
def main():
    ...
    if args.test_only:
        # Test using best or checkpoint model
        if args.resume_best:
            model_path = best_model_path
        elif args.resume:
            model_path = checkpoint_path
        else:
            print("!! Error: --test_only requires --resume_best or --resume to specify which model to test !!")
            return
        if os.path.isfile(model_path):
            print(f"\n==> Test Only Mode: Evaluating model at {model_path} on Test Set...")
            ...
            print(f"!! Error: {model_path} not found. Test evaluation skipped !!")
    else:
        # Normal mode: test after training
        if os.path.isfile(best_model_path):
